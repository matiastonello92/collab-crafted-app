...
import { UserLeavesList } from './UserLeavesList'
        ...
        {canManageContracts ? (
          <Tabs defaultValue="current" className="w-full">
            <TabsList className="grid w-full grid-cols-5">
              ...
              <TabsTrigger value="leaves">Permessi</TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="leaves" className="mt-6"><UserLeavesList userId={userId} /></TabsContent>
          </Tabs>
        ) : (
