...
import { Copy, Lock, Send, RefreshCw } from 'lucide-react'
import type { Rota, Location } from '@/types/shifts'
  ...
  return (
    <>
      <div className="w-80 border-r bg-card p-6 space-y-6 overflow-y-auto">
        ...
        {/* TODO: Filtri utenti/ruoli */}
        {/* TODO: Badge ferie/assenze */}
      </div>
