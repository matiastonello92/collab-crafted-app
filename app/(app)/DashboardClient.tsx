...
export default function DashboardClient({ locationName, permissions }: { locationName: string | null; permissions: string[] }) {
  useRequireSession()
          ...
          <TooltipProvider>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {quickActions.map((action, index) => {
                const canAccess = can(permSet, action.permission)
