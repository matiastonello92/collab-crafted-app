    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        ...
        >
          ...
          {count > 0 && (
            <Badge 
              className="absolute -top-1 -right-1 h-4 min-w-[16px] px-0.5 bg-red-500 hover:bg-red-500 text-white text-[10px] font-bold rounded-full flex items-center justify-center"
            >
              {count > 99 ? '99+' : count}
            </Badge>
          )}
