...
export const it = {
  ...
  recipes: {
    ...
    steps: {
      ...
      stepNumberAuto: 'Il numero dello step è assegnato automaticamente',
      ...
      reordered: 'Ordine degli step modificato con successo',
      errorSaving: 'Errore salvataggio step',
      errorDeleting: 'Errore eliminazione step',
      errorReordering: 'Errore nel riordinare gli step',
      items: 'items',
      min: 'min',
    },
