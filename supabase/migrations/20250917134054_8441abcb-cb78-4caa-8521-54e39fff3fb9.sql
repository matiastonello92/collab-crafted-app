-- Final migration: Update invitation_accept_v2 to use RBAC instead of location_admins
...
BEGIN
  ...
  LOOP
    ...
    -- REMOVED: No longer adding to location_admins as we migrated to RBAC
    -- Manager permissions are now handled through user_roles_locations above
