...
-- SEED: crea default org e collega admin -------------------
...
declare
  ...
  v_uid uuid;
begin
  -- Crea organizzazione default se non esiste
  insert into organizations (name, slug, status, timezone)
  values ('Pecora Negra', 'pecora-negra', 'active', 'Europe/Paris')
  ...
  -- Crea dominio default se non esiste  
  insert into organization_domains (org_id, domain, is_primary)
  values (v_org, 'pecoranegra.fr', true)
